...
If you believe you have found a security vulnerability in `z4j-flask`,
...
This integration starts the agent inside Flask processes, reads agent secrets,
and resolves native engine handles from Flask configuration/import paths.
Secret handling, import-path resolution, engine discovery, and startup failure
isolation are package-specific security surfaces;
